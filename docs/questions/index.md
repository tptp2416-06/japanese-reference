...
<div class="jp-home" style="max-width: 640px; margin: 0 auto; padding: 2rem 0;">
  ...
  <div style="margin-bottom: 3rem;">
    <div style="display: flex; align-items: baseline; gap: 16px; margin-bottom: 0.5rem;">
      <span style="font-size: 36px; color: var(--md-default-fg-color--lighter); font-weight: 400;">問</span>
      <p style="font-size: 28px; font-weight: 500; margin: 0;">Questions</p>
    </div>
    <p style="font-size: 14px; color: var(--md-default-fg-color--lighter); margin: 0; max-width: 480px;">Deep dives into specific grammar questions — clause structure, word order, and sentence mechanics.</p>
    <div style="width: 40px; height: 1px; background: var(--md-default-fg-color--lightest); margin: 1.5rem 0 0;"></div>
  </div>

  <div style="display: flex; flex-direction: column; gap: 0;">

    <a href="noun-modify-clause/" style="display: flex; align-items: baseline; justify-content: space-between; padding: 1.25rem 0; border-top: 0.5px solid var(--md-default-fg-color--lightest); text-decoration: none; color: inherit;">
      <div style="display: flex; align-items: baseline; gap: 16px;">
        <span style="font-size: 24px; color: var(--md-default-fg-color--lighter); font-weight: 400; min-width: 32px;">修</span>
        <div>
          <p style="font-size: 16px; font-weight: 500; margin: 0;">Noun-Modifying Clauses</p>
          <p style="font-size: 13px; color: var(--md-default-fg-color--lighter); margin: 4px 0 0;">Breaking down clause-before-noun structures in real sentences</p>
        </div>
      </div>
