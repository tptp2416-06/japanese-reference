...
en: Please do not touch this box.
note: In a posted notice, the polite request functions as a firm prohibition.
bd: この箱に|this box / 触らないでください*|please do not touch
pat: V-ない + でください
```
...
| `ないで` | direct spoken request | keeps the request and drops the polite ending | very common in conversation; casual, intimate, urgent or blunt by context; see [[nai-de]] |
| `ないでね` | warm direct request | seeks agreement or softens the appeal | casual and often warm, though tone can make it insistent; see [[nai-de]] |
| `ないでいただけませんか` | indirect request | asks deferentially whether the listener could refrain | highly deferential and useful when imposing; related to the favour-receiving pattern in [[te-ageru-te-kureru-te-morau]] |
| `ないでもらえますか` | indirect request | asks whether the speaker can receive the favour of non-action | polite and less direct than ないでください; see [[te-ageru-te-kureru-te-morau]] |
...
A: この箱[はこ]、開[あ]けてもいいですか。 | May I open this box?
B: すみません、開[あ]けないでください。 | I'm sorry, please don't open it.
```

The same ないで shape can also carry an intimate plea or reassurance when ください is absent:

```dialog
note: The casual ending and the relationship turn the form into reassurance rather than a public prohibition.
A: 本当[ほんとう]にごめん。 | I'm really sorry.
