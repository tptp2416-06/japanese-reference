...
### If は is not the subject marker, what is が doing?
...
誰が来た？ "who came?" is answered ハルが来た "Haru came" — here the requested
subject is also the sentence's focus, which is what が supplies.
...
昔々、おじいさんがいました "once upon a time there was an old man" puts him into
the conversation with が.

おじいさんは山へ行きました "the old man went to the mountains" then talks about
him with は. Without a special contrastive or focusing context, reversing them
would sound marked.
...
!!! warning "Pitfall"
    ...
    In the answer too, ハルが作った is the neutral one. ハルは作った shifts the
...
### What happens to は inside a longer sentence?
...
- **The minimal pair is the clearest demonstration** — お酒を飲まない "I don't
  drink alcohol" is neutral object marking. お酒は飲まない "alcohol, I don't
  drink" selects alcohol against the alternatives.
- **The unsaid half can do the work** — 犬は好き。猫はちょっと…… "I like dogs.
  Cats, though…" sets the two against each other with は and lets the sentence
...
### Why do negatives attract は so often?
...
much weight the speaker puts on the は.
...
- **Naming the frame invites the comparison** — ここでは吸えません "you can't
  ...
  other places.
- **On a scale, the frame is a point rather than a place** — ここまでは分かる "I
  follow it this far" and 今日からは "from today on" fence off what lies on the
  other side.
